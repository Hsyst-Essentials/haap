...
Abra a pasta do HAAP (onde tem o [package.json](https://github.com/Hsyst-Essentials/haap/blob/main/package.json)) e execute no terminal/cmd aberto nesta pasta o comando abaixo:
...
Abra o [index.js](https://github.com/Hsyst-Essentials/haap/blob/main/index.js) e edite as linhas de 18 a 57 de acordo com o que você queira ativado ou não.

## Realize a execução do script
Execute o comando abaixo no CMD/Terminal na pasta do HAAP (onde tem o [index.js](https://github.com/Hsyst-Essentials/haap/blob/main/index.js))
